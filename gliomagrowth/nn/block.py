...
class MultiInputConvDecoder(ConvModule):
    ...
    def __init__(
        ...
        dropout_op: Optional[type] = None,
        dropout_kwargs: Optional[Dict] = None,
        upsample_op: type = nn.Upsample,
        upsample_kwargs: Optional[Dict] = None,
        initial_upsample_op: Optional[type] = nn.Upsample,
        initial_upsample_kwargs: Optional[Dict] = None,
        output_activation_op: Optional[type] = None,
